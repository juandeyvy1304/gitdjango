...
class ContactForm(forms.Form):
    ...
    correo = forms.EmailField(label="Correo electronico", required=True, widget=forms.EmailInput(attrs={'class':'form-control', 'placeholder':'escribe tu correo electronico'}))
